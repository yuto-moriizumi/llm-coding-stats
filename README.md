...
- `app/data/llm-data.ts`: モデル名、provider、OpenRouter slug、Arena Score、基本価格、deprecated フラグを管理します。
...
2. OpenRouter から価格や throughput を補完するモデルは、`app/data/llm-data.ts` のモデル定義に `openrouterSlug` を追加します。
