...
- `app/data/llm-models.ts`: モデル名、provider、OpenRouter slug、Arena Score、基本価格、deprecated フラグを管理します。
...
1. `app/data/llm-models.ts` の `LLM_MODELS` にモデル、provider、Arena Score、基本価格を追加または更新します。
2. OpenRouter から価格や throughput を補完するモデルは、`app/data/llm-models.ts` のモデル定義に `openrouterSlug` を追加します。
