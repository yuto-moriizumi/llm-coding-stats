...
export const LLM_MODELS: LLMModelDefinition[] = [
  ...
  { name: "claude-opus-4-8-thinking", provider: "anthropic", arenaScore: 1559, openrouterSlug: "anthropic/claude-opus-4.8" },
  ...
  { name: "claude-opus-4-6", provider: "anthropic", arenaScore: 1535, openrouterSlug: "anthropic/claude-opus-4.6" },
  { name: "claude-sonnet-4-6", provider: "anthropic", arenaScore: 1521, openrouterSlug: "anthropic/claude-sonnet-4" },
  { name: "claude-sonnet-5-high", provider: "anthropic", arenaScore: 1546, openrouterSlug: "anthropic/claude-sonnet-5" },
  ...
  // ── OpenAI ─────────────────────────────────────────────────
  { name: "gpt-5.6-sol-xhigh", provider: "openai", arenaScore: 1631, openrouterSlug: "openai/gpt-5.6-sol" },
  ...
  { name: "gpt-5.3-codex (codex-harness)", provider: "openai", arenaScore: 1407, openrouterSlug: "openai/gpt-5.3-codex" },
  ...
  { name: "gpt-5.4", provider: "openai", arenaScore: 1391, openrouterSlug: "openai/gpt-5.4" },
  ...
  // ── Google ─────────────────────────────────────────────────
  { name: "gemini-3.5-flash-medium", provider: "google", arenaScore: 1497, openrouterSlug: "google/gemini-3.5-flash" },
  ...
  { name: "gemma-4-31b", provider: "google", arenaScore: 1369, openrouterSlug: "google/gemma-4-31b-it" },
  ...
  // ── Zhipu AI (GLM) ────────────────────────────────────────
  { name: "glm-5.2 (max)", provider: "zhipu", arenaScore: 1581, openrouterSlug: "z-ai/glm-5.2" },
  { name: "glm-5.1", provider: "zhipu", arenaScore: 1527, openrouterSlug: "z-ai/glm-5.1" },
  { name: "glm-5v-turbo", provider: "zhipu", arenaScore: 1404, openrouterSlug: "z-ai/glm-5v-turbo" },
  ...
  { name: "glm-4.6", provider: "zhipu", arenaScore: 1356, openrouterSlug: "z-ai/glm-4.6" },

  // ── Moonshot AI (Kimi) ─────────────────────────────────────
  { name: "kimi-k2.6", provider: "moonshot", arenaScore: 1513, openrouterSlug: "moonshotai/kimi-k2.6" },
  { name: "kimi-k2.7-code", provider: "moonshot", arenaScore: 1471, openrouterSlug: "moonshotai/kimi-k2.7" },
  ...
  // ── MiniMax ────────────────────────────────────────────────
  { name: "minimax-m3", provider: "minimax", arenaScore: 1495, openrouterSlug: "minimax/minimax-m3" },
  ...
  // ── Alibaba (Qwen) ─────────────────────────────────────────
  { name: "qwen3.7-max-20260517", provider: "alibaba", arenaScore: 1518, openrouterSlug: "qwen/qwen3.7-max" },
  ...
  { name: "qwen3.5-397b-a17b", provider: "alibaba", arenaScore: 1397, openrouterSlug: "qwen/qwen3.5-397b-a17b" },
  ...
  { name: "qwen3-coder-480b-a35b-instruct", provider: "alibaba", arenaScore: 1282, openrouterSlug: "qwen/qwen3-coder-480b-a35b-instruct" },

  // ── Xiaomi (MiMo) ─────────────────────────────────────────
  { name: "mimo-v2.5-pro", provider: "xiaomi", arenaScore: 1475, openrouterSlug: "xiaomi/mimo-v2.5-pro" },
  { name: "mimo-v2.5", provider: "xiaomi", arenaScore: 1430, openrouterSlug: "xiaomi/mimo-v2.5" },
  ...
  { name: "deepseek-v4-pro-thinking", provider: "deepseek", arenaScore: 1458, openrouterSlug: "deepseek/deepseek-v4-pro" },
  ...
  // ── xAI (Grok) ────────────────────────────────────────────
  { name: "grok-4.5", provider: "xai", arenaScore: 1557, openrouterSlug: "x-ai/grok-4.5" },
  { name: "grok-4.20-beta-0309-reasoning", provider: "xai", arenaScore: 1383, openrouterSlug: "x-ai/grok-4.20" },
  ...
  { name: "grok-4-fast-reasoning", provider: "xai", arenaScore: 1151, deprecated: true, openrouterSlug: "x-ai/grok-4-fast" },
  ...
  // ── Inception Labs ─────────────────────────────────────────
  { name: "mercury-2", provider: "inception", arenaScore: 1165, openrouterSlug: "inception/mercury-2" },

  // ── Poolside ───────────────────────────────────────────────
  { name: "laguna-m.1", provider: "poolside", arenaScore: 1358, openrouterSlug: "poolside/laguna-m.1" },
  { name: "laguna-xs.2", provider: "poolside", arenaScore: 1303, openrouterSlug: "poolside/laguna-xs.2" },

  // ── ByteDance (Seed) ──────────────────────────────────────
  { name: "seed-2.1-pro-preview", provider: "bytedance", arenaScore: 1536, openrouterSlug: "bytedance/seed-2.1-pro-preview" },
];
