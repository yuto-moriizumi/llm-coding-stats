...
export const LLM_MODELS: LLMModelDefinition[] = [
  { name: "kimi-k3", provider: "moonshot", arenaScore: 1678, openrouterSlug: "moonshotai/kimi-k3" },
  { name: "claude-fable-5", provider: "anthropic", arenaScore: 1634, openrouterSlug: "anthropic/claude-fable-5" },
  { name: "gpt-5.6-sol-xhigh (codex-harness)", provider: "openai", arenaScore: 1630, openrouterSlug: "openai/gpt-5.6-sol" },
  ...
  { name: "claude-opus-4-7-thinking", provider: "anthropic", arenaScore: 1559, openrouterSlug: "anthropic/claude-opus-4.7" },
  { name: "grok-4.5", provider: "xai", arenaScore: 1557, openrouterSlug: "x-ai/grok-4.5" },
  { name: "claude-opus-4-7", provider: "anthropic", arenaScore: 1556, openrouterSlug: "anthropic/claude-opus-4.7" },
  { name: "claude-sonnet-5-high", provider: "anthropic", arenaScore: 1544, openrouterSlug: "anthropic/claude-sonnet-5" },
  ...
  { name: "gemini-3.6-flash", provider: "google", arenaScore: 1537, openrouterSlug: "google/gemini-3.6-flash" },
  ...
  { name: "seed-2.1-pro-preview", provider: "bytedance", arenaScore: 1530, openrouterSlug: "bytedance/seed-2.1-pro-preview" },
  { name: "hy3", provider: "tencent", arenaScore: 1527, openrouterSlug: "tencent/hy3" },
  ...
  { name: "qwen3.7-max-20260517", provider: "alibaba", arenaScore: 1515, openrouterSlug: "qwen/qwen3.7-max" },
  { name: "gpt-5.5-xhigh (codex-harness)", provider: "openai", arenaScore: 1507, openrouterSlug: "openai/gpt-5.5" },
  { name: "gemini-3.5-flash", provider: "google", arenaScore: 1504, openrouterSlug: "google/gemini-3.5-flash" },
  ...
  { name: "gemini-3.5-flash-medium", provider: "google", arenaScore: 1488, openrouterSlug: "google/gemini-3.5-flash" },
  { name: "gpt-5.5-high (codex-harness)", provider: "openai", arenaScore: 1483, openrouterSlug: "openai/gpt-5.5" },
  ...
  { name: "gpt-5.5 (codex-harness)", provider: "openai", arenaScore: 1451, openrouterSlug: "openai/gpt-5.5" },
  ...
  { name: "inkling", provider: "other", arenaScore: 1421, openrouterSlug: "other/inkling" },
  ...
  { name: "minimax-m2.5", provider: "minimax", arenaScore: 1381, openrouterSlug: "minimax/minimax-m2.5" },
  ...
  { name: "hunyuan-hy3-preview", provider: "tencent", arenaScore: 1362, openrouterSlug: "tencent/hunyuan-hy3-preview" },
  { name: "grok-4.3", provider: "xai", arenaScore: 1360, openrouterSlug: "x-ai/grok-4.3" },
  { name: "gemma-4-26b-a4b", provider: "google", arenaScore: 1360, openrouterSlug: "google/gemma-4-26b-a4b-it" },
  ...
  { name: "laguna-m.1", provider: "poolside", arenaScore: 1352, openrouterSlug: "poolside/laguna-m.1" },
  { name: "gpt-5.1", provider: "openai", arenaScore: 1339, deprecated: true, openrouterSlug: "openai/gpt-5.1" },
  ...
  { name: "devstral-medium-2507", provider: "mistral", arenaScore: 1093, openrouterSlug: "mistralai/devstral-medium-2507" },
];
