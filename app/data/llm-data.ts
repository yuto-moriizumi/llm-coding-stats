...
export const LLM_MODELS: LLMModel[] = [
  // ── Anthropic ──────────────────────────────────────────────
  { name: "claude-fable-5", provider: "anthropic", arenaScore: 1650, inputPrice: 10, outputPrice: 50 },
  ...
  { name: "claude-opus-4-6-thinking", provider: "anthropic", arenaScore: 1544, inputPrice: 5, outputPrice: 25 },
  ...
  { name: "claude-sonnet-5-high", provider: "anthropic", arenaScore: 1544, inputPrice: 2, outputPrice: 10 },
  ...
  { name: "gpt-5.5-high", provider: "openai", arenaScore: 1481, inputPrice: 0, outputPrice: 0 },
  { name: "gpt-5.4-high", provider: "openai", arenaScore: 1457, inputPrice: 2.5, outputPrice: 15 },
  { name: "gpt-5.5", provider: "openai", arenaScore: 1450, inputPrice: 0, outputPrice: 0 },
  ...
  // ── Google ─────────────────────────────────────────────────
  { name: "gemini-3.5-flash-medium", provider: "google", arenaScore: 1501, inputPrice: 1.5, outputPrice: 9 },
  { name: "gemini-3.1-pro-preview", provider: "google", arenaScore: 1444, inputPrice: 2, outputPrice: 12 },
  ...
  { name: "glm-5v-turbo", provider: "zhipu", arenaScore: 1403, inputPrice: 1.2, outputPrice: 4 },
  ...
  { name: "kimi-k2.5-thinking", provider: "moonshot", arenaScore: 1432, inputPrice: 0.6, outputPrice: 3 },
  ...
  { name: "qwen3.6-plus", provider: "alibaba", arenaScore: 1459, inputPrice: 0.33, outputPrice: 1.95 },
  ...
  // ── xAI (Grok) ────────────────────────────────────────────
  { name: "grok-4.5", provider: "xai", arenaScore: 1572, inputPrice: 2, outputPrice: 6 },
  ...
  { name: "grok-4-fast-reasoning", provider: "xai", arenaScore: 1151, inputPrice: 0.2, outputPrice: 0.5, deprecated: true },
  { name: "grok-code-fast-1", provider: "xai", arenaScore: 1140, inputPrice: 0.2, outputPrice: 1.5, deprecated: true },

  // ── Mistral ────────────────────────────────────────────────
  { name: "mistral-medium-3.5", provider: "mistral", arenaScore: 1268, inputPrice: 1.5, outputPrice: 7.5 },
  ...
  // ── ByteDance (Seed) ──────────────────────────────────────
  { name: "seed-2.1-pro-preview", provider: "bytedance", arenaScore: 1537, inputPrice: 0, outputPrice: 0 },
];
