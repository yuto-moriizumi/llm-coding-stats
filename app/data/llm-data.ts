...
export const LLM_MODELS: LLMModel[] = [
  // ── Anthropic ──────────────────────────────────────────────
  { name: "claude-fable-5", provider: "anthropic", arenaScore: 1649, inputPrice: 10, outputPrice: 50 },
  { name: "claude-opus-4-7-thinking", provider: "anthropic", arenaScore: 1557, inputPrice: 5, outputPrice: 25 },
  ...
  { name: "claude-opus-4-8", provider: "anthropic", arenaScore: 1534, inputPrice: 5, outputPrice: 25 },
  ...
  { name: "claude-sonnet-5-high", provider: "anthropic", arenaScore: 1543, inputPrice: 2, outputPrice: 10 },
  ...
  // ── OpenAI ─────────────────────────────────────────────────
  { name: "gpt-5.6-sol-xhigh (codex-harness)", provider: "openai", arenaScore: 1636, inputPrice: 5, outputPrice: 30 },
  { name: "gpt-5.5-xhigh (codex-harness)", provider: "openai", arenaScore: 1502, inputPrice: 0, outputPrice: 0 },
  { name: "gpt-5.5-high (codex-harness)", provider: "openai", arenaScore: 1481, inputPrice: 0, outputPrice: 0 },
  { name: "gpt-5.4-high (codex-harness)", provider: "openai", arenaScore: 1457, inputPrice: 2.5, outputPrice: 15 },
  { name: "gpt-5.5 (codex-harness)", provider: "openai", arenaScore: 1450, inputPrice: 0, outputPrice: 0 },
  { name: "gpt-5.4-medium (codex-harness)", provider: "openai", arenaScore: 1437, inputPrice: 2.5, outputPrice: 15 },
  { name: "gpt-5.3-codex (codex-harness)", provider: "openai", arenaScore: 1406, inputPrice: 1.75, outputPrice: 14 },
  ...
  { name: "gpt-5.4", provider: "openai", arenaScore: 1392, inputPrice: 2.5, outputPrice: 15 },
  ...
  // ── Google ─────────────────────────────────────────────────
  { name: "gemini-3.5-flash-medium", provider: "google", arenaScore: 1500, inputPrice: 1.5, outputPrice: 9 },
  ...
  { name: "gemma-4-31b", provider: "google", arenaScore: 1370, inputPrice: 0.14, outputPrice: 0.4 },
  { name: "gemma-4-26b-a4b", provider: "google", arenaScore: 1361, inputPrice: 0, outputPrice: 0 },
  ...
  // ── Meta ────────────────────────────────────────────────────
  { name: "muse-spark-1.1", provider: "meta", arenaScore: 1540, inputPrice: 1.25, outputPrice: 4.25 },

  // ── Zhipu AI (GLM) ────────────────────────────────────────
  { name: "glm-5.2 (max)", provider: "zhipu", arenaScore: 1580, inputPrice: 1.4, outputPrice: 4.4 },
  { name: "glm-5.1", provider: "zhipu", arenaScore: 1527, inputPrice: 1.4, outputPrice: 4.4 },
  { name: "glm-5v-turbo", provider: "zhipu", arenaScore: 1402, inputPrice: 1.2, outputPrice: 4 },
  ...
  { name: "kimi-k2.7-code", provider: "moonshot", arenaScore: 1469, inputPrice: 0.72, outputPrice: 3.49 },
  { name: "kimi-k2.5-thinking", provider: "moonshot", arenaScore: 1433, inputPrice: 0.6, outputPrice: 3 },
  ...
  // ── MiniMax ────────────────────────────────────────────────
  { name: "minimax-m3", provider: "minimax", arenaScore: 1496, inputPrice: 0.6, outputPrice: 2.4 },
  { name: "minimax-m2.7", provider: "minimax", arenaScore: 1395, inputPrice: 0.24, outputPrice: 0.96 },
  { name: "minimax-m2.1-preview", provider: "minimax", arenaScore: 1392, inputPrice: 0.3, outputPrice: 1.2 },
  { name: "minimax-m2.5", provider: "minimax", arenaScore: 1382, inputPrice: 0.15, outputPrice: 0.9 },
  { name: "minimax-m2", provider: "minimax", arenaScore: 1305, inputPrice: 0.26, outputPrice: 1.02 },

  // ── Alibaba (Qwen) ─────────────────────────────────────────
  { name: "qwen3.7-max-20260517", provider: "alibaba", arenaScore: 1521, inputPrice: 1.25, outputPrice: 3.75 },
  { name: "qwen3.6-max-preview", provider: "alibaba", arenaScore: 1480, inputPrice: 1.04, outputPrice: 6.24 },
  { name: "qwen3.6-plus", provider: "alibaba", arenaScore: 1458, inputPrice: 0.33, outputPrice: 1.95 },
  { name: "qwen3.5-397b-a17b", provider: "alibaba", arenaScore: 1396, inputPrice: 0.39, outputPrice: 2.45 },
  ...
  { name: "qwen3-coder-480b-a35b-instruct", provider: "alibaba", arenaScore: 1281, inputPrice: 0.4, outputPrice: 1.6 },

  // ── Xiaomi (MiMo) ─────────────────────────────────────────
  { name: "mimo-v2.5-pro", provider: "xiaomi", arenaScore: 1473, inputPrice: 0.43, outputPrice: 0.87 },
  { name: "mimo-v2.5", provider: "xiaomi", arenaScore: 1429, inputPrice: 0.1, outputPrice: 0.28 },
  { name: "mimo-v2-pro", provider: "xiaomi", arenaScore: 1431, inputPrice: 1, outputPrice: 3 },
  ...
  { name: "deepseek-v3.2-thinking", provider: "deepseek", arenaScore: 1368, inputPrice: 0.21, outputPrice: 0.32 },
  { name: "deepseek-v3.2", provider: "deepseek", arenaScore: 1332, inputPrice: 0.21, outputPrice: 0.32 },
  { name: "deepseek-v3.2-exp", provider: "deepseek", arenaScore: 1288, inputPrice: 0.27, outputPrice: 0.41 },

  // ── xAI (Grok) ────────────────────────────────────────────
  { name: "grok-4.5", provider: "xai", arenaScore: 1566, inputPrice: 2, outputPrice: 6 },
  { name: "grok-4.20-beta-0309-reasoning", provider: "xai", arenaScore: 1382, inputPrice: 2, outputPrice: 6 },
  { name: "grok-4.3", provider: "xai", arenaScore: 1362, inputPrice: 1.25, outputPrice: 2.5 },
  ...
  // ── Mistral ────────────────────────────────────────────────
  { name: "mistral-medium-3.5", provider: "mistral", arenaScore: 1267, inputPrice: 1.5, outputPrice: 7.5 },
  ...
  // ── Tencent ────────────────────────────────────────────────
  { name: "hunyuan-hy3-preview", provider: "tencent", arenaScore: 1361, inputPrice: 0, outputPrice: 0 },
  ...
  // ── Arcee AI ───────────────────────────────────────────────
  { name: "trinity-large-thinking", provider: "arcee", arenaScore: 1243, inputPrice: 0.25, outputPrice: 0.8 },

  // ── Inception Labs ─────────────────────────────────────────
  { name: "mercury-2", provider: "inception", arenaScore: 1164, inputPrice: 0.25, outputPrice: 0.75 },

  // ── Poolside ───────────────────────────────────────────────
  { name: "laguna-m.1", provider: "poolside", arenaScore: 1354, inputPrice: 0.2, outputPrice: 0.4 },
  { name: "laguna-xs.2", provider: "poolside", arenaScore: 1303, inputPrice: 0.1, outputPrice: 0.2 },
