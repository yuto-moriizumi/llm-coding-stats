...
export const LLM_MODELS: LLMModel[] = [
  ...
  { name: "claude-opus-4-6-thinking", provider: "anthropic", arenaScore: 1541, inputPrice: 5, outputPrice: 25 },
  { name: "claude-opus-4-8", provider: "anthropic", arenaScore: 1541, inputPrice: 5, outputPrice: 25 },
  ...
  { name: "gpt-5.4", provider: "openai", arenaScore: 1398, inputPrice: 2.5, outputPrice: 15 },
  ...
  { name: "gemma-4-31b", provider: "google", arenaScore: 1373, inputPrice: 0.14, outputPrice: 0.4 },
  ...
  // ── Zhipu AI (GLM) ────────────────────────────────────────
  { name: "glm-5.2 (max)", provider: "zhipu", arenaScore: 1595, inputPrice: 1.4, outputPrice: 4.4 },
  ...
  { name: "kimi-k2.7-code", provider: "moonshot", arenaScore: 1478, inputPrice: 0.75, outputPrice: 3.5 },
  ...
  // ── MiniMax ────────────────────────────────────────────────
  { name: "minimax-m3", provider: "minimax", arenaScore: 1511, inputPrice: 0.6, outputPrice: 2.4 },
  ...
  // ── Alibaba (Qwen) ─────────────────────────────────────────
  { name: "qwen3.7-max-20260517", provider: "alibaba", arenaScore: 1531, inputPrice: 1.25, outputPrice: 3.75 },
  ...
  // ── Xiaomi (MiMo) ─────────────────────────────────────────
  { name: "mimo-v2.5-pro", provider: "xiaomi", arenaScore: 1470, inputPrice: 0.43, outputPrice: 0.87 },
  { name: "mimo-v2.5", provider: "xiaomi", arenaScore: 1433, inputPrice: 0.14, outputPrice: 0.28 },
  ...
  // ── Poolside ───────────────────────────────────────────────
  { name: "laguna-m.1", provider: "poolside", arenaScore: 1347, inputPrice: 0, outputPrice: 0 },
  { name: "laguna-xs.2", provider: "poolside", arenaScore: 1298, inputPrice: 0, outputPrice: 0 },
];
