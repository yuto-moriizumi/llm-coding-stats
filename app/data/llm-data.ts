...
export const LLM_MODELS: LLMModel[] = [
  ...
  { name: "claude-opus-4-7-thinking", provider: "anthropic", arenaScore: 1563, inputPrice: 5, outputPrice: 25 },
  { name: "claude-opus-4-8-thinking", provider: "anthropic", arenaScore: 1565, inputPrice: 5, outputPrice: 25 },
  ...
  { name: "claude-opus-4-8", provider: "anthropic", arenaScore: 1542, inputPrice: 5, outputPrice: 25 },
  ...
  { name: "claude-haiku-4-5-20251001", provider: "anthropic", arenaScore: 1326, inputPrice: 1, outputPrice: 5 },

  // ── OpenAI ─────────────────────────────────────────────────
  { name: "gpt-5.5-xhigh", provider: "openai", arenaScore: 1502, inputPrice: 0, outputPrice: 0 },
  { name: "gpt-5.5-high", provider: "openai", arenaScore: 1484, inputPrice: 0, outputPrice: 0 },
  { name: "gpt-5.4-high", provider: "openai", arenaScore: 1457, inputPrice: 2.5, outputPrice: 15 },
  { name: "gpt-5.5", provider: "openai", arenaScore: 1449, inputPrice: 0, outputPrice: 0 },
  ...
  { name: "gpt-5.4", provider: "openai", arenaScore: 1411, inputPrice: 2.5, outputPrice: 15 },
  ...
  { name: "gemini-3.1-flash-lite-preview", provider: "google", arenaScore: 1249, inputPrice: 0.25, outputPrice: 1.5 },
  { name: "gemini-2.5-pro", provider: "google", arenaScore: 1204, inputPrice: 1.25, outputPrice: 10 },

  // ── Zhipu AI (GLM) ────────────────────────────────────────
  { name: "glm-5.2 (max)", provider: "zhipu", arenaScore: 1593, inputPrice: 1.4, outputPrice: 4.4 },
  { name: "glm-5.1", provider: "zhipu", arenaScore: 1529, inputPrice: 1.4, outputPrice: 4.4 },
  { name: "glm-5", provider: "zhipu", arenaScore: 1434, inputPrice: 1, outputPrice: 3.2 },
  ...
  { name: "kimi-k2.7-code", provider: "moonshot", arenaScore: 1479, inputPrice: 0.75, outputPrice: 3.5 },
  ...
  { name: "kimi-k2-thinking-turbo", provider: "moonshot", arenaScore: 1329, inputPrice: 1.15, outputPrice: 8 },

  // ── Meta ───────────────────────────────────────────────────
  { name: "muse-spark", provider: "meta", arenaScore: 1507, inputPrice: 0, outputPrice: 0 },

  // ── MiniMax ────────────────────────────────────────────────
  { name: "minimax-m3", provider: "minimax", arenaScore: 1505, inputPrice: 0.6, outputPrice: 2.4 },
  { name: "minimax-m2.7", provider: "minimax", arenaScore: 1395, inputPrice: 0.25, outputPrice: 1 },
  ...
  // ── Alibaba (Qwen) ─────────────────────────────────────────
  { name: "qwen3.7-max-20260517", provider: "alibaba", arenaScore: 1530, inputPrice: 1.25, outputPrice: 3.75 },
  ...
  { name: "qwen3.5-397b-a17b", provider: "alibaba", arenaScore: 1395, inputPrice: 0.39, outputPrice: 2.34 },
  ...
  // ── Xiaomi (MiMo) ─────────────────────────────────────────
  { name: "mimo-v2.5-pro", provider: "xiaomi", arenaScore: 1471, inputPrice: 0.43, outputPrice: 0.87 },
  { name: "mimo-v2.5", provider: "xiaomi", arenaScore: 1432, inputPrice: 0.14, outputPrice: 0.28 },
  ...
  // ── DeepSeek ───────────────────────────────────────────────
  { name: "deepseek-v4-pro-thinking", provider: "deepseek", arenaScore: 1458, inputPrice: 0.43, outputPrice: 0.87 },
  ...
  { name: "grok-4.20-beta-0309-reasoning", provider: "xai", arenaScore: 1385, inputPrice: 2, outputPrice: 6 },
  { name: "grok-4.3", provider: "xai", arenaScore: 1364, inputPrice: 1.25, outputPrice: 2.5 },
  ...
  // ── Arcee AI ───────────────────────────────────────────────
  { name: "trinity-large-thinking", provider: "arcee", arenaScore: 1244, inputPrice: 0.22, outputPrice: 0.85 },
